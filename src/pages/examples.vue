<template>
  <section>
    ...
    <input id="text1" type="text" name="text1" class="border-grey border-2">
    ...
    <pre>Quid enim interest, divitias, opes, valitudinem bona dicas
...
qua erat transfixus, hastam.
    ...
    <dl>
      ...
      <dd>Hinc ceteri particulas arripere conati suam quisque videro voluit afferre sententiam.</dd>
